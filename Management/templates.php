...
<body>
    ...
    <div id="content" class="content">
    	...
    	<div>
    		<ul>
    			<li><a href="documents/templates/项目.xlsx">项目</a></li>
    			<li><a href="documents/templates/论文.xlsx">论文</a></li>
    			<li><a href="documents/templates/专利.xlsx">专利</a></li>
    			<li><a href="documents/templates/软件著作权.xlsx">软件著作权</a></li>
    			<li><a href="documents/templates/会议.xlsx">会议</a></li>
    			<li><a href="documents/templates/获奖.xlsx">获奖</a></li>
    		</ul>
    	</div>
	</div>
</body>
